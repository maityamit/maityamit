...
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| Project Mentor | <img src="https://github.com/maityamit/maityamit/blob/main/Images/Organizations/1602335093424.jpeg" alt="Rait" width="30" height="30"/> | [Kharagpur Winter of Code](https://kwoc.kossiitkgp.org/) | ```Android``` <br> ```Java``` <br> ```Firebase```| [Sleepometer](https://github.com/maityamit/Sleepometer-Android-App) | Dec 22 - Current |  |
| Head of App Dev | <img src="https://github.com/maityamit/maityamit/blob/main/Images/Organizations/gdsc.png" alt="Rait" width="30" height="30"/> | [GDSC Glb](https://gdsc.community.dev/gl-bajaj-institute-of-technology-and-management-greater-noida/) | ```Android``` <br> ```Compose``` |  | Sep 22 - Current |  |
| Project Mentor & Contributor | <img src="https://github.com/maityamit/maityamit/blob/main/Images/Organizations/hacktoberfest.jpg" alt="Rait" width="30" height="30"/> | [Hacktoberfest](https://hacktoberfest.com/) | ```Android``` ```Java``` <br> ```Firebase``` |  | Oct 22 - Oct 22 | [Completed](https://github.com/maityamit/maityamit/blob/main/Images/Certificate/hactoberfest.png) |
