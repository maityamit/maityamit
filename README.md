...
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| Head of App Dev | <img src="" alt="Rait" width="30" height="30"/> | [GDSC Glb](https://gdsc.community.dev/gl-bajaj-institute-of-technology-and-management-greater-noida/) | ```Android``` <br> ```Compose``` |  | Sep 22 - Current |  |
